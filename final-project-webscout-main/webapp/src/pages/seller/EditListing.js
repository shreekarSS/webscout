...
const CreateListing = () => {
    const [values, setValues] = useState({ 'Name': '', 'cost': '', 'desc': "", 'address': "", 'beds': "", 'zipcode': '', 'baths': "", 'files': ['fvrgeththty6'], 'phone': "", 'contactEmail': "" });
    const Submit = 'Submit';
    ...
    return (
        <div>
            ...
            <div className='form-container'>
                <form className='create-listing-form' onSubmit={handleSubmit}>
                    {submitted && valid ? <div className='success-message'>Updated successfully!</div> : null}
                    <input
        ...
        {submitted && !values.Files ? <span>Please enter a Files</span> : null} */}
                    ...
                    <input
                        ...
                        name="email" />
                    {submitted && !values.contactEmail ? <span>Please enter a Email Addressl</span> : null}
                    ...
                    <div>
                        <button
                            ...
                            type="submit" onClick={() => { console.log("Triggered"); dispatch(addProperty(values)) }}>Update</button>
                    </div>
                </form>
